...
extern "C" {
  ...
  G_GNUC_INTERNAL void web_message_set_request_stream (WebMessage* web_message, const gchar* content_type, GInputStream* stream);
  ...
  G_GNUC_INTERNAL void web_message_set_response (WebMessage* web_message, const gchar* content_type, const gchar* request, gsize length);
  G_GNUC_INTERNAL void web_message_set_response_stream (WebMessage* web_message, const gchar* content_type, GInputStream* stream);
  G_GNUC_INTERNAL void web_message_set_response_take (WebMessage* web_message, const gchar* content_type, gchar* request, gsize length);
